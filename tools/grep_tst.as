...
;	(b/c CP/M converts the command line arguments to all upper case):
;
;	psect bss  -> psect BSS
...
;	May 2025 Ho-Ro
;
;	Testversion grep_tst.as to simplify the CP/M build:
;	1. reorder the psects bss, data, text -> text, data, bss
;	2. remove all psect pseudo opcodes
;	3. add org 100h to the start of the file
;
;	z80as grep_tst.as
;	linq -z -c100h -ogrep_tst.com grep_tst.obj
;
;	This creates an identical com file
;
;	To assemble also with HiTech C zas.com
;	change all defm "string" -> defm 'string'
;
;	z80as grep_tst.as
;	linq -z -c100h -ogrep_tst.com grep_tst.obj
;
;	$ md5sum grep.com grep_tst.com
;	5e1f9071d560742479b4fb1b34dda1ea  grep.com
;	5e1f9071d560742479b4fb1b34dda1ea  grep_tst.com
;
;	June 2025 Ho-Ro
;
